...
const Rocket = ({ style }) => (
  <svg viewBox="0 0 60 80" style={style} fill="none">
    ...
    <ellipse cx="30" cy="68" rx="5" ry="3" fill="#FFD93D" opacity="0.55"/>
  </svg>
);
...
const Cloud = ({ style }) => (
  <svg viewBox="0 0 120 60" style={style} fill="none">
    <ellipse cx="60" cy="42" rx="50" ry="18" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
    <ellipse cx="40" cy="34" rx="22" ry="18" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
    <ellipse cx="72" cy="30" rx="26" ry="20" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
    <ellipse cx="55" cy="26" rx="18" ry="14" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
  </Cloud>
);
...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#F8F5F0", fontFamily:"'Nunito',sans-serif",
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .card:hover{transform:translateY(-2px) scale(1.01);box-shadow:0 10px 26px rgba(0,0,0,.09)!important;}
        .fab{transition:transform .2s,box-shadow .2s;}
        .fab:hover{transform:translateX(-50%) scale(1.13) rotate(12deg)!important;box-shadow:0 12px 32px rgba(255,140,0,.5)!important;}
        .fab:active{transform:translateX(-50%) scale(.92)!important;}
      ...
      <div style={{ position:"fixed", inset:0, pointerEvents:"none", zIndex:0, overflow:"hidden" }}>
        {BG_DOTS.map((d,i) => (
          <div key={i} style={{
            ...
            background:d.c, opacity:.18,
            left:d.l, top:d.t,
            animation:`float ${d.a}s ease-in-out ${i*.3}s infinite`,
          }}/>
        ))}
      </div>
      ...
      {screen==="home" && (
        <div style={{ position:"relative", zIndex:1, paddingBottom:110 }}>
          ...
          <div style={{
            ...
            borderBottom:"2px solid #EDE5D8", padding:"22px 20px 18px",
            position:"relative", overflow:"hidden",
          }}>
            {/* cloud deco */}
            <svg viewBox="0 0 120 60" style={{ position:"absolute",right:-8,top:-6,width:130,opacity:.35 }} fill="none">
              <ellipse cx="60" cy="42" rx="50" ry="18" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
              <ellipse cx="40" cy="34" rx="22" ry="18" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
              <ellipse cx="72" cy="30" rx="26" ry="20" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
              <ellipse cx="55" cy="26" rx="18" ry="14" fill="white" stroke="#E8E0D5" strokeWidth="1.5"/>
            </svg>
            <Star style={{ position:"absolute",right:28,top:16,width:26,animation:"wiggle 2.2s ease-in-out infinite" }}/>
            <Star style={{ position:"absolute",right:60,top:30,width:16,opacity:.6,animation:"wiggle 3s ease-in-out .5s infinite" }}/>
          ...
          <div style={{ padding:"14px 16px 0",display:"flex",gap:8,overflowX:"auto" }}>
            {[{label:"All ✨",color:"#FF8C00",idx:null},...CATEGORIES.map((c,i)=>({...c,idx:i}))].map(c=>(
              <div
                key={c.label} className="chip"
                onClick={() => setFilterCat(c.idx)}
                style={{
                  background: filterCat===c.idx ? c.color : "white",
                  border:`2px solid ${filterCat===c.idx ? c.color : "#EEE5D8"}`,
                  borderRadius:20, padding:"5px 13px",
                  fontSize:12, fontWeight:700, whiteSpace:"nowrap",
                  color: filterCat===c.idx ? "white" : "#999",
                  boxShadow: filterCat===c.idx ? `0 4px 12px ${c.color}55` : "none",
                }}>
          ...
          {/* tiny plant deco */}
          <div style={{ display:"flex",justifyContent:"flex-end",paddingRight:14,marginTop:2 }}>
            <Plant style={{ width:38,height:38,opacity:.6 }}/>
          </div>
          ...
          <div style={{ padding:"4px 14px 0" }}>
            ...
            {pending.map((t,i) => (
              <TaskCard key={t.id} task={t} idx={i}
                ...
                onClick={()=>{setSelected(t);setScreen("detail");}}/>
            ))}
            ...
            {completed.length>0 && (
              <>
                <div style={{ display:"flex",alignItems:"center",gap:8,margin:"16px 0 8px" }}>
                  ...
                  <span style={{ fontSize:11,color:"#CCC",fontWeight:800,letterSpacing:.5 }}>COMPLETED 🎉</span>
                  <div style={{ flex:1,height:1.5,background:"#EEE5D8" }}/>
                </div>
                {completed.map((t,i) => (
                  <TaskCard key={t.id} task={t} idx={i} done
                    onCheck={e=>{e.stopPropagation();toggle(t.id);}}
                    onClick={()=>{setSelected(t);setScreen("detail");}}/>
                ))}
              </>
          ...
          <button
            ...
            style={{
              ...
              border:"none",
              boxShadow:"0 6px 22px rgba(255,140,0,.5),0 2px 6px rgba(0,0,0,.1)",
      ...
      {/* ═══════════════ ADD ═══════════════ */}
      {screen==="add" && (
        <div style={{ position:"relative",zIndex:1,animation:"slideUp .35s ease",minHeight:"100vh",paddingBottom:40 }}>
          ...
          <div style={{
            ...
            <button onClick={()=>setScreen("home")} style={{
              ...
              transition:"transform .15s",
               ...
               onMouseOut={e=>e.currentTarget.style.transform=""}>←</button>
            <div>
            ...
            <Rocket style={{ marginLeft:"auto",width:30,height:36,animation:"float 2s ease-in-out infinite" }}/>
          </div>
          ...
          <div style={{ padding:"20px 16px",display:"flex",flexDirection:"column",gap:14 }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: form.title.trim()&&form.time ? "0 6px 20px rgba(255,140,0,.4)" : "none",
          ...
          <Cat style={{ position:"fixed",bottom:10,right:10,width:64,height:64,opacity:.22,pointerEvents:"none" }}/>
        </div>
      )}

      {/* ═══════════════ DETAIL ═══════════════ */}
      {screen==="detail" && selected && (
        <div style={{ position:"relative",zIndex:1,animation:"slideUp .3s ease",minHeight:"100vh" }}>
          <div style={{
            background:"linear-gradient(135deg,#FFF9F2,#FFF3E0)",
            borderBottom:"2px solid #EDE5D8",
              ...
              <div style={{ display:"flex",gap:8,flexWrap:"wrap",marginBottom:20 }}>
                {[
                  ...
                  <span key={txt} style={{
                    ...
                    borderRadius:20,padding:"4px 12px",fontSize:12,fontWeight:700,color:"#555",
                  }}>{txt}</span>
                ))}
              </div>
              ...
              <div style={{ display:"flex",gap:10 }}>
                <button
                  ...
                  style={{
                    ...
                    color:"white",fontFamily:"'Fredoka One'",fontSize:16,cursor:"pointer",
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius:16,padding:"14px 18px",fontSize:18,cursor:"pointer",
                  }}>🗑️</button>
              </div>
            </div>
          </div>
      ...
      {success && (
        <div style={{
          ...
          background:"rgba(255,249,242,.88)",backdropFilter:"blur(5px)",
        }}>
          <div style={{ textAlign:"center",animation:"successPop .4s ease" }}>
            <div style={{ fontSize:78 }}>🚀</div>
            <p style={{ fontFamily:"'Fredoka One'",fontSize:28,color:"#FF8C00",marginTop:8 }}>Task Added!</p>
            <Star style={{ width:40,margin:"8px auto 0",animation:"spin 1s linear infinite" }}/>
          </div>
        </div>
      )}
    </div>
...
/* ── helpers ── */
function TaskCard({ task, idx, onCheck, onClick, done }) {
  ...
  return (
    <div className="card" onClick={onClick} style={{
      ...
      display:"flex",alignItems:"center",gap:12,
      opacity:done?.65:1,
      animation:`fadeSlide .35s ease ${idx*.06}s both`,
      cursor:"pointer",
    }}>
      <div onClick={onCheck} style={{
        ...
        display:"flex",alignItems:"center",justifyContent:"center",
        transition:"transform .15s",
        boxShadow:done?"0 2px 8px rgba(98,219,98,.35)":"none",
      }}
      ...
      <div style={{
        ...
        background:pri.color,boxShadow:`0 2px 6px ${pri.color}88`,
      }}/>
    </div>
  );
}
...
function Box({ label, children }) {
  return (
    <div style={{
      ...
      boxShadow:"0 3px 14px rgba(0,0,0,.05)",border:"2px solid #F0E8D8",
    }}>
      <p style={{ fontSize:11,fontWeight:900,color:"#C0A888",letterSpacing:.5 }}>{label}</p>
      {children}
    </div>
  );
}
